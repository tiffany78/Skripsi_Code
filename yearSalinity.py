...
folder = Path("/Users/tipanoii/doc/TA/code/seaweed/salinity")
...
for file in nc_files:
    ...
    if sal_var is None:
        print(f"⚠️ Skip {file.name} (tidak ada variabel salinitas)")
        continue

    print("Variabel salinitas:", sal_var)
    ...
    plt.title(f"Salinitas - {file.stem}")
