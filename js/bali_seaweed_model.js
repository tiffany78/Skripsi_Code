...
function exportTIFF(img, prefix, year) {
  ...
  Export.image.toDrive({
    ...
    description: "Sentinel2_Bali_10_" + year,
    folder: 'TA_GEOTIFF',
    scale: 10,
    region: bali_seaweed,
    maxPixels: 1e13,
...
years.forEach(function(y) {
  ...
  Map.addLayer(
    comps.median.clip(bali_seaweed), 
  ...
  Map.addLayer(ndwiClass.clip(bali_seaweed), ndwiClassVis, 'NDWI Class ' + y);
