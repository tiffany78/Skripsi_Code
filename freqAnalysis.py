...
if MODE == "seaweed":
    ...
    ROOT_FREQ = ROOT / "output_frequency_tif2"
...
OUT_FACTOR_DIR = ROOT / "output_factor2"
OUT_CSV_DIR = ROOT / "output_csv2"
...
def load_sal_temp_for_year(year, freq):
    ...
    return sal_on_freq, temp_on_freq
...
def process_one_combination(freq_tif, depth_tif):
    ...
    # =========================================================
    sal_on_freq, temp_on_freq = load_sal_temp_for_year(year, freq)
