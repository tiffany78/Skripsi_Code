...
def process_one_tif(input_tif: Path):
    ...
    OUTPUT_MASK_TIF  = output_dir / f"mask_{base_name}_{minArea_str}_{MERGE_GAP_PIXELS}_noCheck.tif"
    OUTPUT_ZONE_TIF  = output_dir / f"zone_{base_name}_{minArea_str}_{MERGE_GAP_PIXELS}_noCheck.tif"
    OUTPUT_CLASS_TIF = output_dir / f"class_{base_name}_{minArea_str}_{MERGE_GAP_PIXELS}_noCheck.tif"
    OUTPUT_PNG       = output_dir / f"peta_{base_name}_{minArea_str}_{MERGE_GAP_PIXELS}_noCheck.png"
    OUTPUT_CSV       = output_dir / f"ringkasan_{base_name}_{minArea_str}_{MERGE_GAP_PIXELS}_noCheck.csv"
